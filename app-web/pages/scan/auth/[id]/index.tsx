  ...
  return (
    <>
      <NextSeo
        ...
        additionalLinkTags={[{
          rel: "alternate",
          href: `${configPrefix.url_host}${configPrefix.pageAuth}/${configPrefix.startAuth}${router.query.id}/rss.xml`,
...
export async function getServerSideProps(ctx) {
  ...
  if (id != null && id.length > 0) {
    _fixid = id.toString().replace(configPrefix.startAuth, '');
  }

  data = await (await axios.get(URL_DATA.MG_LIST_MANGA_AUTH + _fixid + '/' + (page - 1))).data;
