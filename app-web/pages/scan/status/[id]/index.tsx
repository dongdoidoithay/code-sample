  ...
  return (
    <>
      <NextSeo
        ...
        additionalLinkTags={[{
          rel: "alternate",
          href: `${configPrefix.url_host}${configPrefix.pageStatus}/${configPrefix.startStatus}${router.query.id}/rss.xml`,
      ...
      <div className="main-container">
        <div className="container">
          ...
          </div><div className='row mt-1 d-flex flex-wrap-reverse'>
...
export async function getServerSideProps(ctx) {
  ...
  if (id != null && id.length > 0) {
    _fixid = id.toString().replace(configPrefix.startStatus, '');
  }

  data = await (await axios.get(URL_DATA.MG_LIST_MANGA_STATUS + _fixid + '/' + (page - 1))).data;
