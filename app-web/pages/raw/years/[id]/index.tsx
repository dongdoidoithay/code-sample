  ...
  return (
    ...
    <NextSeo
      title={`${configSeting.sb_seo_page_group_title
        ...
        .replace(/{groupname}/g,configSeting.lbl_inf_Year)
      ...
      additionalLinkTags={[{
        rel: "alternate",
        href: `${configPrefix.url_host}${configPrefix.pageYear}/${configPrefix.startYear}${router.query.id}/rss.xml`,         
...
console.log('intype')
  ...
  data = await (await axios.get(URL_DATA.MG_LIST_MANGA_YEAR + _fixid + '/' + (page-1))).data;
